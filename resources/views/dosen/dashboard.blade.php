                                ...
                                <div class="row" style="height: 100px;">
                                    ...
                                    <div class="col-8">
                                        <div class="text-primary p-3">
                                            <h5 class="text-primary fw-semibold">{{ $dosen->nama }}</h5>
                                            <p class="mb-0 fw-semibold">Program Studi {{ $dosen->program_studi }}
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        ...
                                                        <h5 class="font-size-12 mb-3 text-primary">{{ $dosen->alamat }}
                                                        </h5>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <p class="text-muted mb-0">Tempat Tanggal Lahir</p>
                                                        <h5 class="font-size-12 mb-3 text-primary">
                                                            {{ $dosen->tempat_lahir }},{{ $dosen->tanggal_lahir }}
                                                        </h5>
                                                        ...
                                                        <h5 class="font-size-12 mb-3 text-primary">
                                                            {{ $dosen->website_personal }}</h5>
                                                    </div>

                                                </div>
                                                {{-- <div class="text-right col-sm-12">
                                                    <a href="{{ url('layout/dashboard/edit', $dosen->id) }}"
