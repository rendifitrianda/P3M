        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row pengusul">
                    <h4 class="text-bold font-size-16 text-uppercase" style="color: rgb(73, 80, 87); font-weight: bold;">
                        ...
                        <div class="pengusul_overlay p-5 text-center bg-image rounded-3"
                            ...
                            <div class="mask text-white">
                                <div class="d-flex justify-content-start align-items-center h-100">
                                    <p class="font-size-14 text-white text-left" style="font-weight: 400;">Anda dapat
                                        mengajukan usulan <br>terkait dengan layanan berikut :</p>
                                </div>
                            </div>
                            <div class="pengusul_wrapper d-flex align-items-center justify-content-center gap-3"><a
                                    class="card pengusul_card mini-stats-wid px-1 py-1 px-sm-5 py-sm-3"
                                    href="/penelitian/usulan/v2">
                                    <div class="pengusul_card_body card-body">
                                    ...
                                    <div class="pengusul_card_body card-body">
                                        <div class="d-flex text-primary gap-2 align-items-center"
                                            style="font-weight: bold;"><i
                                                class="bx bx-star font-size-24 text-primary"></i>Pengabdian</div>
                                    </div>
                                </a></div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <h4 class="text-primary text-uppercase font-size-14">Status usulan terakhir</h4>
                    <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <h3 class="font-size-14 mb-4 text-truncate"
                                                style="font-weight: bold; color: rgb(73, 80, 87);">Pemetaan Wilayah
                                                Rawan Banjir Menggunakan Sistem Informasi Geografis Dalam Mitigasi
                                        ...
                                        <div class="wizard-steps-wrapper">
                                            <div class="wizard-steps completed">
                                                ...
                                                <div>
                                                    ...
                                                    <div><label class="text-muted block font-size-10">-</label></div>
                                                </div>
                                            </div>
                                            <div class="wizard-steps completed">
                                                <div class="wizard-steps-dot"><i class="fa fa-check"></i></div>
                                            ...
                                            <div class="wizard-steps completed">
                                                ...
                                                <div class="wizard-steps-line second"></div>
                                                <div>
                                                    <div><label class="text-primary font-size-12 mb-0 ">Tahapan Seleksi
                                                            Lanjutan</label></div>
                                                    <div><label class="text-muted block font-size-10">-</label></div>
                                                </div>
                                            </div>
                                            <div class="wizard-steps completed">
                                                ...
                                                <div class="wizard-steps-line second"></div>
                                                <div>
                                                    <div><label class="text-primary font-size-12 mb-0 ">Tahapan Pasca
                                                            Pelaksanaan Kegiatan</label></div>
                                                    <div><label class="text-muted block font-size-10">21-04-2024</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div
                                            ...
                                            <span class="avatar-title"><i
                                                    class="bx bx-user-circle font-size-24"></i></span></div>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                            ...
                            <div class="mini-stats-wid card">
                                <div class="menu_profile_items card-body">
                                    <div class="d-flex">
                                        ...
                                        <div
                                            class="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                                            <span class="avatar-title"><i class="bx bx-search font-size-24"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                                        <span class="avatar-title"><i
                                                class="bx bx-purchase-tag font-size-24"></i></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4"><a href="/sinta">
                            <div class="mini-stats-wid card">
                                <div class="menu_profile_items card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <p class="text-muted fw-medium menu_profile_title">Sinta Skor Overall</p>
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <h5 class="font-size-12 mb-3 text-primary">Kelompok PT Madya</h5>
                                                <p class="text-muted mb-0">Institusi</p>
                                                <h5 class="font-size-12 mb-3 text-primary">Politeknik Negeri Ketapang
                                                </h5>
                                                <p class="text-muted mb-0">Program Studi</p>
                                                <h5 class="font-size-12 mb-3 text-primary">Teknologi Informasi</h5>
                                                ...
                                                <h5 class="font-size-12 mb-3 text-primary"> Desa Bumi Agung</h5>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <p class="text-muted mb-0">Tempat Tanggal Lahir</p>
                                                <h5 class="font-size-12 mb-3 text-primary">Ngawi, 04 Juli 1991</h5>
                                                <p class="text-muted mb-0">No KTP</p>
                                                <h5 class="font-size-12 mb-3 text-primary">6209030407910001</h5>
                                                ...
                                                <h5 class="font-size-12 mb-3 text-primary">darmanto@politap.ac.id</h5>
