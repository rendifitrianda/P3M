...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo e(url('operator/dashboard')); ?>">
                <i class="ri-dashboard-line"></i>
                <span>Dashboard</span>
            </a>
        </li><!-- End Dashboard Nav -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo e(url('operator/dosen')); ?>">
        ...
        <li class="nav-item">
            ...
            <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo e(url('operator/reguler')); ?>">
                        <i class="bi bi-circle"></i><span>Usulan Regular</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('operator/usulan')); ?>">
                        <i class="bi bi-circle"></i><span>Perbaikan Usulan</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('operator/laporan_kemajuan')); ?>">
                        <i class="bi bi-circle"></i><span>Laporan Kemajuan</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('operator/laporan_akhir')); ?>">
                        <i class="bi bi-circle"></i><span>Laporan Akhir</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('operator/catatan_harian')); ?>">
...
<?php /**PATH C:\laragon\www\P3M\resources\views/components/layouts/operator_layouts/sidebar.blade.php ENDPATH**/ ?>